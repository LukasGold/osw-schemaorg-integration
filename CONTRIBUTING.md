...
Welcome to `osw-schemaorg-integration` contributor's guide.
...
If you experience bugs or general issues with `osw-schemaorg-integration`, please have a look
...
You can help improve `osw-schemaorg-integration` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`osw-schemaorg-integration` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `osw-schemaorg-integration`'s files. While this mechanism can
...
```
conda create -n osw-schemaorg-integration python=3 six virtualenv pytest pytest-cov
conda activate osw-schemaorg-integration
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/osw-schemaorg-integration.git
   cd osw-schemaorg-integration
   ```
...
5. Install [pre-commit]:
   ...
   `osw-schemaorg-integration` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/osw-schemaorg-integration
[issue tracker]: https://github.com/<USERNAME>/osw-schemaorg-integration/issues
